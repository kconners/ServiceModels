...
namespace ClientDataModel.StandardModels
{
    public class CouponDef
    {
        ...
        public string passdefid { get; set; }
        public string logofilename { get; set; }
        public string startdate { get; set; }
        public string expirydate { get; set; }
        public string usesallowed { get; set; }
        public string usesperyear { get; set; }
        public string usespermonth { get; set; }
        public string usesperweek { get; set; }
